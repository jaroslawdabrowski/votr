...
public class PollServiceExposureTest {
    ...
    public void testList() {
        ...
        when(archivist.listAccounts())
            .thenReturn(Arrays.asList(new Poll("5479", "1", "Checking account"), new Poll("5479", "2", "Savings account")));
    ...
    public void testGet() {
        ...
        when(archivist.getAccount("5479", "1234")).thenReturn(new Poll("5479", "1234", "Savings account"));
    ...
    public void testCreate() throws Exception {
        ...
        when(accountUpdate.getName()).thenReturn("new Poll");
        ...
        assertEquals("new Poll", resp.getName());
    ...
    public void testUpdate() throws Exception {
        ...
        Poll existingAcc = new Poll("5479", "12345678", "Savings account");
