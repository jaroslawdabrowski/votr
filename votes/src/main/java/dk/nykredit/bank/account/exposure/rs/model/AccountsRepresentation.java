...
public class AccountsRepresentation {
    ...
    public AccountsRepresentation(List<Poll> polls, UriInfo uriInfo) {
        this.accounts = new ArrayList<>();
        this.accounts.addAll(polls.stream().map(account -> new AccountRepresentation(account, uriInfo)).collect(Collectors.toList()));
